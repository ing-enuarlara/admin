                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                $where="";
                                if($_SESSION["datosUsuarioActual"]['usr_tipo']!=DEV){
                                    $where= "WHERE ctipo_id_empresa='".$_SESSION["idEmpresa"]."'";
                                }
                                try{
                                    $tipoProd= $conexionBdComercial->query("SELECT * FROM comercial_marca_productos $where");
                                } catch (Exception $e) {
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="tipo-producto-editar.php?id=<?=$result[0];?>" data-toggle="tooltip">Editar</a>
                                                <!--<div class="dropdown-divider"></div>-->
                                                <a class="dropdown-item" href="../bd_delete/tipo-producto-eliminar.php?id=<?=$result[0];?>" onClick="if(!confirm('Este registro se eliminará del sistema, Desea continuar bajo su responsabilidad?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
