								...
								<form class="form-horizontal" method="post" action="../bd_create/combos-guardar.php" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Titulo para el combo" name="titulo">
										</div>
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<textarea class="form-control" rows="3" placeholder="Descripción del combo" name="descripcion" id="detalles"></textarea>
											</div>
										</div>

										<div class="form-group col-md-2">
											<label for="inputDescuento">Descuento:</label>
											<input type="number" class="form-control" id="inputDescuento" placeholder="Tiene descuento el combo?" name="desc">
										</div>
