          ...
          <div class="container-fluid">
              <div class="row mb-2">
                  ...
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?=REDIRECT_ROUTE?>modules/comercial/bd_read/tipo-producto.php">Ver Tipo de Productos</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="col-md-12">
                                    <!-- form start -->
                                <form class="form-horizontal" method="post" action="../bd_update/tipo-producto-actualizar.php" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                        <div class="form-group col-md-6">
                                            <label for="exampleInputEmail1">Nombre:</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre del Tipo de Productos" name="nombre" value="<?=$resultadoD['ctipo_nombre'];?>">
                                        </div>
                                        <div class="form-group col-md-6" style="display:block;" id="groupMasJoyas">
                                            <label>Estado:</label>
                                            <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="estado" id="estado">
                                              <option value=""></option>
                                              <option value="1"<?php if($resultadoD['ctipo_estado']==1){echo "selected";}?>>Activo</option>
                                              <option value="0"<?php if($resultadoD['ctipo_estado']==0){echo "selected";}?>>Inactivo</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
