            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
					    ...
					    <a href="categorias-catalogo-agregar.php" class="btn btn-primary"><i class="fas fa-solid fa-plus"></i> Agregar Categoria del Catalogo</a>
                        <?php
                            if(!empty($filtro)){
                        ?>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                if (!empty($filtro)) {
                                    ...
                                    $predicado = !empty($predicado) ? array_merge($predicado, [Categorias_Catalogo_Principal::OTHER_PREDICATE => $filtro]) : [Categorias_Catalogo_Principal::OTHER_PREDICATE => $filtro];
                                }
                                Clientes_Admin::foreignKey(Clientes_Admin::INNER, [
                                    "cliAdmi_id" => 'ccatp_id_empresa'
                                ]);
                                $categorias = Categorias_Catalogo_Principal::SelectJoin(
                                    $predicado,
                                    "*",
                                    [
                                ...
                                foreach ($categorias as $result){
                                    $menu="NO";
                                    if($result['ccatp_menu']==1){
                                        $menu="SI";
                                    }
                                    $footer="NO";
                                    if($result['ccatp_footer']==1){
                                        $footer="SI";
                                    }
                                ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="categorias-catalogo-editar.php?id=<?=$result['ccatp_id'];?>" data-toggle="tooltip">Editar</a>
                                                <!--<div class="dropdown-divider"></div>-->
                                                <a class="dropdown-item" href="../bd_delete/categorias-catalogo-eliminar.php?id=<?=$result['ccatp_id'];?>" onClick="if(!confirm('Este registro se eliminará del sistema, Desea continuar bajo su responsabilidad?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
