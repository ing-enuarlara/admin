                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    LEFT JOIN " . BDADMIN . ".localidad_paises ON pais_id=cli_pais
                                    ...
                                    while ($result = mysqli_fetch_array($clientes, MYSQLI_BOTH)) {
                                        $bgColor = '';
                                        $cheked = '';
                                        if ($result['cli_bloqueado'] == 1) {
                                            $bgColor = '#ff572238';
                                            $cheked = 'checked';
                                        }
                                        $ciudad = $result['ciu_nombre'] . "/" . $result['dep_nombre'];
                                        if ($result['cli_ciudad'] == 1121) {
                                            $ciudad = $result['cli_ciudad_extranjera'];
                                        }
                                    ...
                                    ?>
                                        <tr id="Reg<?= $result['cli_id']; ?>" style="background-color:<?= $bgColor; ?>;">
                                            <td><?= $num; ?></td>
                                            <td>
                                                <input type="checkbox" id="<?= $result['cli_id']; ?>" name="bloqueado" value="1" data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </td>
                                            <td><?= $result['pais_nombre']; ?></td>
                                            <td><?= $ciudad; ?></td>
