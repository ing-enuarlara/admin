					...
					<div class="row">
						...
						<div class="col-md-3">
							...
							<div class="card card-success">
								...
								<!-- /.card-header -->
								<div class="card-body">
									<p><b>1.</b> Descargue la plantilla de excel en este enlace. <a href="<?=REDIRECT_ROUTE."files/excel/Plantilla-Importacion-productos.xlsx"?>" target="_blank" class="btn btn-xs btn-secondary">DESCARGAR PLANTILLA</a></p>
									<p><b>2.</b> Llene los campos de los articulos en el orden que la plantilla los solicita.</p>
									<p><b>3.</b> Finalmente guarde la plantilla ya completada, carguela en el campo que dice <mark>Subir la plantilla lista</mark> y dele click al botón importar articulos.</p>
								</div>
							</div>
							...
							<div class="card card-success">
								...
								<!-- /.card-header -->
								<div class="card-body">
									<p><b>-></b> Tenga en cuenta, para importar los articulos, el campo Cod/Referencia, es obligatorios.</p>
									...
									<p><b>-></b> Si el articulo ya existe en la plataforma, solo debes escribir el ID/Cod/Ref con el que ya esta creado y usted puede seleccionar los campos que desea actualizar en el campo que dice <mark>Campos a actualizar</mark>. Si no selecciona ningun campo entonces los articulos ya existentes se omitirán y solo se ingresarán los que no existan en la plataforma.</p>
								</div>
							</div>
							<!-- /.card -->
						</div>
						<div class="col-md-9">
							...
							<div class="card card-success">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form class="form-horizontal" method="post" action="../../../import-export/excel-importar-catalogo-principal.php" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group col-md-8">
											...
											<small class="form-text text-muted text-red">Primera fila desde donde hay información de los articulos.<br>Esto se usa para evitar que se lean filas que no tienen información.</small>
										</div>
										...
										<div class="form-group col-md-8">
											...
											<small class="form-text text-muted text-red">Fila hasta donde hay información de los articulos.<br>Esto se usa para evitar que se lean filas que no tienen información.</small>
										</div>

										<div class="form-group col-md-8">
											<label>Campos a actualizar:</label>
											<select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="actualizarCampo[]" multiple>
												<option value=""></option>
												...
												<option value="6">Tipo Articulo</option>
												<option value="7">Palabras Claves</option>
												<option value="8">Detalles del Articulo</option>
											</select>
										</div>
										...
										<?php if( !isset($_SESSION['admin']) ){?>
											<div class="form-group col-md-8">
												...
												<select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="idEmpresa">
													...
													<?php
													try {
														$empresa = Clientes_Admin::Select()->fetchAll(PDO::FETCH_ASSOC);
													} catch (Exception $e) {
									...
									<div class="card-footer">
										<button type="submit" class="btn btn-primary">Importar Articulos</button>
									</div>
								</form>
							</div>
							<!-- /.card -->
