            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
					    ...
					    <a href="marcas-agregar.php" class="btn btn-primary"><i class="fas fa-solid fa-plus"></i> Agregar Marcas</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a class="dropdown-item" href="../bd_delete/marcas-eliminar.php?id=<?=$result[0];?>" onClick="if(!confirm('Desea eliminar el registro?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
