...
if($_SESSION["datosUsuarioActual"]['usr_tipo']!=DEV){
    $filtroEmpresa= " AND cmar_id_empresa='".$_SESSION["idEmpresa"]."'";
}
$busqueda='';
$filtro='';
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="marcas-editar.php?id=<?=$result[0];?>" data-toggle="tooltip">Editar</a>
                                                <!--<div class="dropdown-divider"></div>-->
                                                <a class="dropdown-item" href="../bd_delete/marcas-eliminar.php?id=<?=$result[0];?>" onClick="if(!confirm('Este registro se eliminará del sistema, Desea continuar bajo su responsabilidad?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
