					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-success">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form class="form-horizontal" method="post" action="../bd_create/ofertas-guardar.php" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group col-md-6" id="tipoUrl" style="display:none;">
											...
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Url de la Imagen" name="urlImgOferta" id="urlImg">
										</div>
										...
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Titulo de la Ofertas" name="titulo">
										</div>
										...
										<div class="col-sm-6">
											...
											<div class="form-group">
												...
												<textarea class="form-control" rows="3" placeholder="Descripción de la Ofertas" name="descripcion" id="detalles"></textarea>
											</div>
										</div>
										...
										<div class="form-group col-md-6">
											...
											<select data-placeholder="Escoja una opción" class="form-control select2" onchange="escogerArticulos(this.value)" style="width: 100%;" name="tipoOfertas">
												<option value=""></option>
												<option value="<?= TODA ?>" selected>Toda la Tienda</option>
												<option value="<?= PROD ?>">Para Productos</option>
												<option value="<?= CATE ?>">Para Categorias</option>
												<option value="<?= SUB_CATE ?>">Para Sub-Categorias</option>
												<option value="<?= TIPO ?>">Para Tipos de Productos</option>
											</select>
