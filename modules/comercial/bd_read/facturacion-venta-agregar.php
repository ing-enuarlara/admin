...
<script type="text/javascript">
    function clientes(datoscliente){
        ...
        location.href = "facturacion-venta-agregar.php?cte="+id+"&vende=<?=$vende?>";
    }
</script>
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-success">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form class="form-horizontal" method="post" action="../bd_create/facturacion-venta-guardar.php" enctype="multipart/form-data">
                                    <div class="card-body">
