					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="card card-success">
								...
								<!-- /.card-header -->
								<!-- form start -->
								<form class="form-horizontal" method="post" action="../bd_create/marcas-catalogo-guardar.php" enctype="multipart/form-data">
									<div class="card-body">
										<div class="form-group col-md-6">
											<label for="exampleInputEmail1">Nombre:</label>
											<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre de la Sub-Categorias del Catalogo" name="nombre">
										</div>
										<div class="form-group col-md-6">
											...
											<select data-placeholder="Escoja una opción" class="form-control select2" multiple="multiple" style="width: 100%;" name="categorias[]">
												...
												?>
													<option value="<?= $resOp['ccatp_id']; ?>"><?= $resOp['ccatp_nombre'] . $nombreEmpresa; ?></option>
												<?php } ?>
											</select>
										</div>
