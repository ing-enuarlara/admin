...
$resultadoD = Tipos_Catalogo_Principal::Select(
    [
        "ctipop_id" => $_GET["id"]
    ]
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            ...
                            <div class="col-md-12">
                                    <!-- form start -->
                                <form class="form-horizontal" method="post" action="../bd_update/tipo-articulos-actualizar.php" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                        ...
                                        <div class="form-group col-md-6" style="display:block;" id="groupMasJoyas">
                                            ...
                                            <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="estado" id="estado">
                                              <option value=""></option>
                                              <option value="1"<?php if($resultadoD['ctipop_estado']==1){echo "selected";}?>>Activo</option>
                                              <option value="0"<?php if($resultadoD['ctipop_estado']==0){echo "selected";}?>>Inactivo</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
