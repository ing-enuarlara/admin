...
try {
    $resultadoD = Catalogo_Principal::Select(
        [
            "cprin_id" => $_GET["id"]
        ]
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= REDIRECT_ROUTE ?>modules/comercial/bd_read/catalogo-principal.php">Articulos</a></li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h2 class="m-0 float-sm-right"><?= $paginaActual['pag_nombre'] . " de " . $resultadoD['cprin_nombre'] ?></h2>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                try {
                                    ...
                                    Productos_Fotos::Select(
                                        [
                                            "cpf_id_producto" => $_GET["id"],
                                            'cpf_fotos_prin' => SI
                                        ]
                                ...
                                foreach ($consultaFotos as $resultadoFotos) {
                                ...
                                ?>
                                    <div class="col-sm-2">
                                        <a href="<?= $rutaFoto ?>" data-toggle="lightbox" data-title="<?= $resultadoD['cprin_nombre'] ?>" data-gallery="gallery">
            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <form class="form-horizontal" method="post" action="../bd_create/catalogo-principal-fotos-guardar.php" enctype="multipart/form-data">
