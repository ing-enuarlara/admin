          ...
          <div class="container-fluid">
              <div class="row mb-2">
                  ...
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?=REDIRECT_ROUTE?>modules/comercial/bd_read/categorias.php">Ver Categorias</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="post" action="../bd_create/categorias-guardar.php" enctype="multipart/form-data">
                                <div class="card-body">
