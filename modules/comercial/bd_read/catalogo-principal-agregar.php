          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../bd_create/catalogo-principal-guardar.php" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Existencia del Articulo" name="existencia">
                    </div>
                    <div class="form-group col-md-3">
                      ...
                      <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="tipo">
                        ...
                        ?>
                          <option value="<?= $datosTiposProd['ctipop_id']; ?>"><?= $datosTiposProd['ctipop_nombre'] . $nombreEmpresa; ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    <div class="form-group col-md-6">
                      ...
                      <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="categoria" id="categoria" onchange="traerSubCategorias()">
                        ...
                        ?>
                          <option value="<?= $datosCategorias['ccatp_id']; ?>"><?= $datosCategorias['ccatp_nombre'] . $nombreEmpresa; ?></option>
                        <?php } ?>
                      </select>
