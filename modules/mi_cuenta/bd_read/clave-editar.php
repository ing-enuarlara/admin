            ...
            <div class="col-md-4">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h5 class="float-sm-right">Instrucciones</h5>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-11">
                      ...
                      <div class="input-group">
                        <input type="password" class="form-control col-md-4" id="claveActual" oninput="validarClaveActual(this)" placeholder="Ingrese su contraseña actual" name="claveActual" required>
                        <div class="input-group-prepend" onclick="cambiarTipoInput('claveActual')">
                    ...
                    <div class="form-group col-md-11">
                      ...
                      <div class="input-group">
                        <input type="password" class="form-control col-md-4" id="claveNueva" oninput="validarClaveNueva(this)" placeholder="Ingrese una contraseña nueva" name="claveNueva" required>
                        <div class="input-group-prepend" onclick="cambiarTipoInput('claveNueva')">
                          <span class="input-group-text"><i class="fas fa-eye"></i></span>
                        </div>
                      </div>
                    ...
                    <div class="form-group col-md-11">
                      <label for="confirmarClaveNueva">Confirmar Contraseña Nueva:</label>
                      <div class="input-group">
                        <input type="password" class="form-control col-md-4" id="confirmarClaveNueva" oninput="claveNuevaConfirmar(this)" placeholder="Repita la contraseña nueva" name="confirmarClaveNueva" required>
                        <div class="input-group-prepend" onclick="cambiarTipoInput('confirmarClaveNueva')">
                          <span class="input-group-text"><i class="fas fa-eye"></i></span>
                        </div>
                      </div>
