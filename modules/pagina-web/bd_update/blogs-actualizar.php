<?php
    ...
    try{
        $conexionBdPaginaWeb->query("UPDATE blogs SET blogs_titulo='" . $_POST["titulo"] . "', blogs_contenido='" . $_POST["contenido"] . "', blogs_palabras_claves='" . $_POST["pClaves"] . "' WHERE blogs_id='" . $_POST["id"] . "'");
    } catch (Exception $e) {
