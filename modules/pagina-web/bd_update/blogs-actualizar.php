<?php
    ...
    try{
        $conexionBdPaginaWeb->query("UPDATE blogs SET blogs_titulo='" . mysqli_real_escape_string($conexionBdPaginaWeb, $_POST["titulo"]) . "', blogs_contenido='" . mysqli_real_escape_string($conexionBdPaginaWeb, $_POST["contenido"]) . "', blogs_palabras_claves='" . $_POST["pClaves"] . "', blogs_id_categoria='" . $_POST["categoria"] . "', blogs_fecha_creacion='" . $_POST["fecha"] . "' WHERE blogs_id='" . $_POST["id"] . "'");
    } catch (Exception $e) {
