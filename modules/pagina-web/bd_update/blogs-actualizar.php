<?php
    ...
    try{
        $conexionBdPaginaWeb->query("UPDATE blogs SET blogs_titulo='" . $_POST["titulo"] . "', blogs_contenido='" . $_POST["contenido"] . "', blogs_palabras_claves='" . $_POST["pClaves"] . "', blogs_id_categoria='" . $_POST["categoria"] . "' WHERE blogs_id='" . $_POST["id"] . "'");
    } catch (Exception $e) {
