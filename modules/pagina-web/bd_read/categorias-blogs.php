            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="categorias-blogs-agregar.php" class="btn btn-primary"><i class="fas fa-solid fa-plus"></i> Agregar</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                try{
                                    $categorias = $conexionBdPaginaWeb->query("SELECT * FROM categorias_blogs $where");
                                } catch (Exception $e) {
                                ...
                                while($result = mysqli_fetch_array($categorias, MYSQLI_BOTH)){
                                    if($datosUsuarioActual['usr_tipo']==DEV){
                                        try{
                                            $empresa= $conexionBdAdmin->query("SELECT * FROM clientes_admin WHERE cliAdmi_id='".$result['catblo_id_empresa']."'");
                                        } catch (Exception $e) {
                                            include(RUTA_PROYECTO."includes/error-catch-to-report.php");
                                        }
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="categorias-blogs-editar.php?id=<?=$result[0];?>" data-toggle="tooltip">Editar</a>
                                                <!--<div class="dropdown-divider"></div>-->
                                                <a class="dropdown-item" href="../bd_delete/categorias-blogs-eliminar.php?id=<?=$result[0];?>" onClick="if(!confirm('Este registro se eliminará del sistema, Desea continuar bajo su responsabilidad?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
