                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                while($result = mysqli_fetch_array($feedback, MYSQLI_BOTH)){
                                    ...
                                    $texto = htmlspecialchars(strip_tags($result['feed_comentario']));
                                ?>
                                <tr>
                                    <td><?=$num;?></td>
                                    <td><?=$result['feed_nombre_usuario'] ?? "";?></td>
                                    <td title="<?=$texto;?>"
                                    ...
                                    <td>
                                        <?php
                                            for($i=1; $i <= 5; $i++){
                                                echo ($i <= $result['feed_star']) ? '<i class="fas fa-star  text-warning"></i>' : '<i class="far fa-star" style="color: #999;"></i>';
                                            }
                                        ?>
                                    </td>
