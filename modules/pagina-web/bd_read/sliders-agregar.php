          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../bd_create/sliders-guardar.php" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-6" id="tipoFile" style="display:none;">
                      ...
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="imgSlider">
                    ...
                    <div class="form-group col-md-6" id="tipoUrl" style="display:none;">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Url de la Imagen" name="urlImg" id="urlImg">
                    </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Titulo Slider" name="titulo">
                    </div>
