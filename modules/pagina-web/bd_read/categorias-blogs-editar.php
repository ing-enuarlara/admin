...
try{
  $consulta = $conexionBdPaginaWeb->query("SELECT * FROM categorias_blogs WHERE catblo_id='" . $_GET["id"] . "'");
} catch (Exception $e) {
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= REDIRECT_ROUTE ?>modules/pagina-web/bd_read/categorias-blogs.php">Ver Categorias</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../bd_update/categorias-blogs-actualizar.php" enctype="multipart/form-data">
                  <input type="hidden" name="id" value="<?= $_GET["id"]; ?>">
                  <div class="card-body">

                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Nombre Categoria:</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre Categoria" name="nomCategoria" value="<?= $resultadoD['catblo_nombre']; ?>">
                    </div>
                  </div>
                  <!-- /.card-body -->
