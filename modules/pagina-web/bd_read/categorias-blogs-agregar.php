          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../bd_create/categorias-blogs-guardar.php" enctype="multipart/form-data">
                  <div class="card-body">
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Nombre Categoria:</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nombre Categoria" name="nomCategoria">
                    </div>
                  </div>
                  <!-- /.card-body -->
