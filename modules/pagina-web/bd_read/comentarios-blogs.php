                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                try{
                                    $comentarios = $conexionBdPaginaWeb->query("SELECT * FROM comentarios WHERE com_id_blog='".$_POST['id']."' ORDER BY com_id DESC");
                                } catch (Exception $e) {
                                ...
                                while($result = mysqli_fetch_array($comentarios, MYSQLI_BOTH)){
                                    ...
                                    $texto = htmlspecialchars(strip_tags($result['com_comentario']));
                                ?>
                                <tr>
                                    <td><?=$num;?></td>
                                    <td><?=$result['com_nombre_usuario'] ?? "";?></td>
                                    <td title="<?=$texto;?>"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="respuestas-comentarios-blogs.php?id=<?=$result[0];?>&idBlog=<?=$_POST['id'];?>" data-toggle="tooltip">Respuestas</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
