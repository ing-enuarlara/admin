...
try{
  $consulta = $conexionBdPaginaWeb->query("SELECT * FROM blogs WHERE blogs_id='" . $_GET["id"] . "'");
} catch (Exception $e) {
  include(RUTA_PROYECTO."includes/error-catch-to-report.php");
}
$resultadoD = mysqli_fetch_array($consulta, MYSQLI_BOTH);
$rutaFoto = !empty($resultadoD['blogs_imagen']) ? REDIRECT_ROUTE . "files/blogs/" . $resultadoD['blogs_imagen'] : "http://via.placeholder.com/150x150/000000/AAAAAA&amp;text=Ninguna%20Imagen";
?>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="../bd_update/blogs-actualizar.php" enctype="multipart/form-data">
                  <input type="hidden" name="id" value="<?= $_GET["id"]; ?>">
                  <div class="card-body">
                    <div class="col-md-6" style="margin-top: 10px;">
                      <div class="filtr-item col-md-12" data-category="1" data-sort="Foto blogs">
                        <img src="<?= $rutaFoto ?>" class="img-fluid mb-2" alt="Foto blogs" id="imgBlogs" style="margin-left: auto; margin-right: auto; display: flex; flex-wrap: wrap; width: 200px; border-radius: 50%; max-width: 150px;" />
                      </div>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea name="contenido" id="contenido"><?= $resultadoD['blogs_contenido']; ?></textarea>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="categoria" id="categoria">
                        ...
                        while($datosCategorias = mysqli_fetch_array($consultaCategorias, MYSQLI_BOTH)){
                          ...
                          $selected = ($resultadoD['blogs_id_categoria']==$datosCategorias[0]) ? 'selected' : "";
                        ?>
                          <option value="<?=$datosCategorias[0];?>" <?=$selected;?>><?=$datosCategorias['catblo_nombre'].$nombreEmpresa;?></option>
                        <?php }?>
                      </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <textarea name="pClaves" id="pClaves" rows="5" cols="90"><?= $resultadoD['blogs_palabras_claves']; ?></textarea>
                    </div>
                  </div>
                  <!-- /.card-body -->
