<?php
    ...
    try{
        $conexionBdPaginaWeb->query("INSERT INTO blogs(blogs_titulo, blogs_contenido, blogs_palabras_claves, blogs_responsable, blogs_id_categoria, blogs_id_empresa)VALUES('" . $_POST["titulo"] . "', '" . $_POST["contenido"] . "', '" . $_POST["pClaves"] . "', '" . $datosUsuarioActual['usr_id'] . "', '" . $_POST["categoria"] . "', '".$configuracion['conf_id_empresa']."')");
    } catch (Exception $e) {
