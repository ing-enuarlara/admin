                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-success">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="post" action="../bd_create/clientes-admin-guardar.php">
                                <div class="card-body">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Empresa:</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Empresa" name="nombre">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Email:</label>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Aviso Previo" name="aviPrev">
                                    </div>
                                </div>
                                <!-- /.card-body -->
