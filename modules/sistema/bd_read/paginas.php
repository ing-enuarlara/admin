            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
					    ...
					    <a href="paginas-agregar.php" class="btn btn-primary"><i class="fas fa-solid fa-plus"></i> Agregar Pagina</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                ...
                                                <a class="dropdown-item" href="../bd_delete/paginas-eliminar.php?id=<?=$page[0];?>" onClick="if(!confirm('Este registro se eliminará del sistema, Desea continuar bajo su responsabilidad?')){return false;}" data-toggle="tooltip">Eliminar</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
