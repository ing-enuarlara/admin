          ...
          <div class="container-fluid">
              <div class="row mb-2">
                  ...
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item"><a href="<?=REDIRECT_ROUTE?>modules/sistema/bd_read/paginas.php">Ver Paginas</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form class="form-horizontal" method="post" action="../bd_update/paginas-actualizar.php">
                                <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                <div class="card-body">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Nombre:</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$resultadoD['pag_nombre']?>" name="nombre">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputEmail1" value="<?=$resultadoD['pag_ruta']?>" name="ruta">
                                    </div>
                                </div>
                                <!-- /.card-body -->
