                  ...
                  <div class="card-body">
                    <div class="form-group col-md-4">
                      ...
                      <select data-placeholder="Escoja una opción" class="form-control select2" style="width: 100%;" name="ussTipo">
                        ...
                        ?>
                          <option value="<?= $resOp[0]; ?>"><?= $resOp['utipo_nombre'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="email" class="form-control" id="emailInput" placeholder="Email del Usuario" name="email">
                    </div>

                    <div class="form-group col-md-4">
                      <label for="cellInput">Celular:</label>
                      <input type="tel" class="form-control" id="cellInput" placeholder="Celular del Usuario" name="celular">
                    </div>
