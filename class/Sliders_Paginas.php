...
class Sliders_Paginas extends BDT_Tablas implements BDT_JoinImplements {
    public static $schema = BDMODPAGINAWEB;

    public static $tableName = 'sliders_paginas';

    public static $primaryKey = 'slp_id';

    public static $tableAs = 'slp';
