<?php
require_once(RUTA_PROYECTO."/class/Conexion_Factory.php");
...
class Conexion extends Conexion_Factory{
    ...
    protected function conexionPDO()
    {
        ...
        try {
            //if($this->conexionPDO === null) {
                ...
                $this->conexionPDO = new PDO("mysql:host=".SERVER.";dbname=".BDADMIN.";charset=utf8mb4", USER, PASS);
    ...
    protected function conexion()
    {
        //if($this->conexionMysql === null) {
            $this->conexionMysql = mysqli_connect(SERVER, USER, PASS, BDADMIN);
